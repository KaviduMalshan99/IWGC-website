...
<!-- rts faq area start -->
<div class="rts-faq-area rts-section-gapBottom faq-banner" style="margin-top: 80px; background-image: url('{{ asset('public/frontend/assets/images/new/FAQ Boy.webp') }}'); height: 900px; background-size: cover; background-position: center; position: relative;">

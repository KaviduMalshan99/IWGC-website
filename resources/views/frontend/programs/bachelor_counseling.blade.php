...
<!-- Banner Section -->
<div class="partner-breadcrumb" style="background-image: url('{{ asset('public/frontend/assets/images/Bachelor of Counseling 01.webp') }}'); background-size: cover; background-position: top;height: 400px;position: relative;">
</div>
                    ...
                    <div class="team-details-right-inner">
                        <div class="title-area" data-animation="fadeInUp" data-delay="0.2">
                            ...
                            <ol class="styled-modules-list">
                                <li>Art therapy</li>
                                <li>Family and Systems Theory</li>
